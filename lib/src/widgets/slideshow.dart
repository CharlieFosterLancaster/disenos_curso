    ...
    return ChangeNotifierProvider(
      ...
      child: SafeArea(
        child: Center(child: Builder(builder: (BuildContext context) {
          ...
          Provider.of<_SlidershowModel>(context).colorPrimario = colorPrimario;
          Provider.of<_SlidershowModel>(context).colorSecundario = colorSecundario;
          Provider.of<_SlidershowModel>(context).bulletPrimario = bulletPrimario;
          Provider.of<_SlidershowModel>(context).bulletSecundario = bulletSecundario;
